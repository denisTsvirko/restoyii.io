                ...
                for ($i=0;$i<7;$i++) {
                    ...
                    echo '<div class="row">
                            <div class="span5 ">';
                               ...
                               /* echo '<pre>';
                        var_dump($dayMenu["MAINS"]);
                    echo '</pre>';
                    die();*/
                                $k=0;
                                //for($k;$k<count($dayMenu["STARTERS"]);$k++){
...
//                                while($dishMenu[$days[$i]][$k]->type=="MAINS"){
//                                    echo '++++++++++++++++';
//                                    echo '<div class = "container_prise">
//                                               <div class="container_prise_el">';
//                                                    echo '<div class="name_eat">'.$dishMenu[$days[$i]][$k]->name.'</div>';
//                                                    echo '<div class="dots"></div>';
//                                                    echo '<div class="cost_eat">$'.$dishMenu[$days[$i]][$k]->cost.'</div>';
//                                                echo '</div>';
//                                                echo '<div class="info_eat">'.$dishMenu[$days[$i]][$k]->info.'</div>';
//                                    echo '</div>';
//                                    $k++;
//                                }
...
//                                while($dishMenu[$days[$i]][$k]->type=="DESSERT"){
//                                    echo '<div class = "container_prise">
//                                              <div class="container_prise_el">';
//                                                echo '<div class="name_eat">'.$dishMenu[$days[$i]][$k]->name.'</div>';
//                                                echo '<div class="dots"></div>';
...
//                                }
                    ...
                    echo '</div>'; //row starters,mains, desserts
